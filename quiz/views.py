...
def base_page():
        ...
        try:
            if type(answer) != type(final_answer):
                ...
                if answer == "True" or answer == "False":
                    ...
                    flash("Should have entered a True or False")
                    return redirect(url_for("base_page"))
        except Exception:
            flash("Should have entered a number")
            return redirect(url_for("base_page"))
    ...
    return render_template("quiz.html", form=form, final_question=final_question, current_difficulty=current_difficulty)
