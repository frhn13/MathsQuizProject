...
def test_generate_sequence_questions(difficulty_factors, question_types):
    ...
    question, answer, difficulty_weighting, time_needed = sequences_question_generation(entered_difficulty=entered_difficulty,
...
def test_generate_linear_sequence_questions(difficulty_factors, question_types):
    ...
    answer = 0
    for x in range(100):
        question, answer, difficulty_weighting, time_needed = sequences_question_generation(entered_difficulty=3,
                                                                           question_types=question_types,
                                                                           difficulty_factors=difficulty_factors)
...
def test_generate_geometric_sequence_questions(difficulty_factors, question_types):
    ...
    answer = 0
    for x in range(100):
        question, answer, difficulty_weighting, time_needed = sequences_question_generation(entered_difficulty=5,
                                                                           question_types=question_types,
                                                                           difficulty_factors=difficulty_factors)
...
def test_generate_quadratic_sequence_questions(difficulty_factors, question_types):
    ...
    answer = 0
    for x in range(100):
        question, answer, difficulty_weighting, time_needed = sequences_question_generation(entered_difficulty=7,
                                                                           question_types=question_types,
                                                                           difficulty_factors=difficulty_factors)
